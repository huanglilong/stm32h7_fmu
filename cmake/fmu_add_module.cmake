...
function(fmu_add_module)
  ...
  set_target_properties(${MODULE} PRIVATE -Wframe-larger-than=${STACK_MAX})
  ...
  if(DEPENDS)
    ...
    foreach(dep ${DEPENDS})
      ...
      if((${dep_type} STREQUAL "STATIC_LIBRARY") OR OR (${dep_type} STREQUAL "INTERFACE_LIBRARY"))
  ...
  foreach(prop LINK_FLAGS STACK_MAIN MAIN PRIORITY)
    if(${prop})
      # set_target_properties(${MOUDLE} PROPERTIES ${property} ${${property}})
      set_target_properties(${MODULE} PROPERITES ${prop} ${${prop}})
    endif()
  endforeach()
